    ...
    <div className="font-sans text-slate-800 bg-gray-50 min-h-screen flex flex-col overflow-x-hidden">
      ...
      <div className="bg-white border-b border-gray-100 py-6 md:py-8 relative z-20 -mt-8 mx-4 md:mx-auto md:max-w-6xl rounded-xl shadow-lg grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 justify-center">
        {[
          ...
          { label: "Cobertura", value: "Nacional", icon: MapPin },
        ].map((stat, i) => (
        ...
        <div className="container mx-auto px-6">
          <FadeInSection>
            <div className="max-w-4xl mx-auto text-center mb-12 md:mb-16">
              ...
              <p className="text-gray-600 text-base md:text-lg leading-relaxed">
                <span className="font-bold text-brand-orange">Ad Finem</span> significa "Hasta el final". No abandonamos el proceso. Nuestra fortaleza radica en un equipo de profesionales que han servido como Jueces, Secretarios y Auxiliares de Magistrados, aportando una visión técnica y realista del litigio en Colombia.
              </p>
            </div>
          </FadeInSection>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { icon: ShieldCheck, title: "Seguridad", desc: "Auditorías que cierran brechas legales antes de la demanda." },
              { icon: Users, title: "Lealtad", desc: "Relaciones a largo plazo basadas en la honestidad brutal." },
              { icon: Gavel, title: "Representación", desc: "Defensa robusta en estrados judiciales." }
            ].map((item, index) => (
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 md:mb-16">
            <div className="md:w-2/3">
              <FadeInSection>
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-brand-teal mt-2">Soluciones Integrales</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              { 
                ...
                text: "Manejo impecable de descargos, actas y terminaciones con justa causa para evitar reintegros." 
              },
              { 
                icon: Scale, 
                title: "Litigio y Defensa", 
                text: "Representación experta en juzgados laborales. Estrategias de conciliación y defensa técnica." 
              },
              { 
                icon: BookOpen, 
              ...
              { 
                ...
                text: "Auditoría de aportes y fiscalización de la UGPP. Prevención de sanciones costosas." 
              },
              { 
                icon: Users, 
              ...
              { 
                ...
                text: "Litigio especializado ante demandas de indemnización por accidentes de trabajo. Desvirtuamos la culpa del empleador mediante probática técnica avanzada, protegiendo a la empresa de pagos multimillonarios por perjuicios." 
              },
              { 
                icon: BookOpen, 
                title: "Recurso de Casación (Corte Suprema)", 
                text: "Representación de alto nivel ante la Corte Suprema de Justicia. Un servicio exclusivo para impugnar sentencias desfavorables, sustentado en una técnica casacional rigurosa y análisis jurisprudencial profundo." 
              }
            ].map((service, idx) => (
               ...
               <div className="md:w-7/12 p-6 md:p-12 lg:p-16 flex flex-col justify-center bg-gradient-to-br from-white to-gray-50">
                 ...
                 <div className="space-y-4 mb-8">
                   <div className="flex gap-4 items-start p-3 rounded-lg hover:bg-white hover:shadow-sm transition-all">
                     ...
                     <p className="text-gray-600 text-sm leading-snug">Abogada especialista de la <strong>Pontificia Universidad Javeriana</strong>.</p>
                   </div>
                   ...
                   <div className="flex gap-4 items-start p-3 rounded-lg hover:bg-white hover:shadow-sm transition-all">
                     ...
                     <p className="text-gray-600 text-sm leading-snug">Ex Asesora de Sala Laboral (Tribunal Superior de Buga y Sincelejo).</p>
                   </div>
                   <div className="flex gap-4 items-start p-3 rounded-lg hover:bg-white hover:shadow-sm transition-all">
                     <div className="bg-brand-teal/10 p-2 rounded-lg">
                       <BookOpen className="h-5 w-5 text-brand-teal flex-shrink-0" />
                     </div>
                     <p className="text-gray-600 text-sm leading-snug">Diplomada en Conciliación y Docencia Universitaria.</p>
                   </div>
                 </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12 md:mb-16">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm leading-relaxed mb-6">
                Consultores Jurídicos especializados en blindar empresas con experiencia desde la rama judicial. Honestidad, Lealtad y Resultados.
              </p>
